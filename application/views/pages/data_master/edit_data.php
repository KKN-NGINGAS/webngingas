            ...
            <div class="card-content">
                ...
                <div class="row">
                    <div class="col-lg-12 mb-3">
                        ...
                        <input type="text" class="form-control input-field" id="nama_ketua" name="nama_ketua" placeholder="Contoh: Bambang Pamungkas" minlength="4" maxlength="80" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        <label for="nik_ketua" class="form-label">NIK</label>
                        <input type="text" class="form-control input-field" id="nik_ketua" name="nik_ketua" placeholder="Contoh: 3304XXXXXXXXXXXX" minlength="4" maxlength="16" required>
                    </div>
                    <div class="col-lg-6 mb-3">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" class="form-control input-field" id="no_telp_ketua" name="no_telp_ketua" placeholder="Format Nomor: +628XXXXXXXXXX" minlength="4" maxlength="16" required>
                    </div>
                    <div class="col-lg-6 mb-3">
                        <label for="email_ketua" class="form-label">Alamat Email Ketua</label>
                        <input type="email" class="form-control input-field" id="email_ketua" name="email_ketua" placeholder="Contoh: email@gmail.com" required>
                    </div>
                    <div class="col-lg-12 mb-3">
                        <label for="alamat_ketua" class="form-label">Alamat Ketua</label>
                        <textarea class="form-control input-field" id="alamat_ketua" name="alamat_ketua" placeholder="Contoh: Jl. Suryajana no. 51 RT/RW 01/03 Kec. Malioboro Yogyakarta" required></textarea>
                    </div>
                </div>
                <div>
                ...
                <div class="row">
                    <div class="col-lg-12 mb-3">
                        ...
                        <input type="text" class="form-control input-field" id="nama_admin" name="nama_admin" placeholder="Contoh: Bambang Pamungkas" minlength="4" maxlength="80" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        <label for="nik_admin" class="form-label">NIK</label>
                        <input type="text" class="form-control input-field" id="nik_admin" name="nik_admin" placeholder="Contoh: 3304XXXXXXXXXXXX" minlength="4" maxlength="16" required>
                    </div>
                    <div class="col-lg-6 mb-3">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <input type="text" class="form-control input-field" id="no_telp_admin" name="no_telp_admin" placeholder="Format Nomor: +628XXXXXXXXXX" minlength="4" maxlength="16" required>
                    </div>
                    <div class="col-lg-6 mb-3">
                        <label for="email_admin" class="form-label">Alamat Email Admin</label>
                        <input type="email" class="form-control input-field" id="email_admin" name="email_admin" placeholder="Contoh: email@gmail.com" required>
                    </div>
                    <div class="col-lg-12 mb-3">
                        <label for="alamat_admin" class="form-label">Alamat Admin</label>
                        <textarea class="form-control input-field" id="alamat_admin" name="alamat_admin" placeholder="Contoh: Jl. Suryajana no. 51 RT/RW 01/03 Kec. Malioboro Yogyakarta" required></textarea>
                    </div>
                </div>
