<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="card-content">
        <?php foreach ($sdm as $row) { ?>
            <form class="spacer-2" style="padding-top: 50px;padding-bottom: 50px;" action="<?= base_url().'MainController/update_user/'.$row->id_user.'/'.$row->id_karyawan.'/'.$row->id_ikm?>" method="POST">
                <div class="row">
