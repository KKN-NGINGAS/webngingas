<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="card-content">
        <div class="col-11 mx-auto">
          <form action="<?php echo base_url() . 'MainController/input_operator'; ?>" method="post" class="spacer-2" style="padding-top: 50px;padding-bottom: 50px;">
            <div class="row">
                <div class="col-lg-6 mb-3">
                    ...
                    <select name="karyawan" id="karyawan" class="form-control input-field" required>
                        <option class="dropdown-item disabled" value="">Pilih Karyawan</option>
                        <?php foreach ($karyawan as $row) { ?>
                            <option value="<?= $row->id_karyawan ?>"><?= $row->nama_karyawan." - ".$row->nik ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 mb-3">
                    ...
                    <input type="text" class="form-control input-field" name="username" id="username" pattern="[A-Za-z0-9]{8,15}" title="Hanya diperbolehkan kombinasi huruf besar, huruf kecil dan angka" placeholder="Masukkan Username" required>
                </div>
                <div class="col-lg-6 mb-3">
