    ...
    <div class="col-11 mx-auto">
      <form class="spacer-2" style="padding-top: 50px;padding-bottom: 50px;">
        <div class="mb-3">
          ...
          <input type="date" class="form-control input-field" id="tanggal_produksi" placeholder="Contoh: 15/09/20">
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="col-lg-6 mb-3">
            ...
            <input type="text" class="form-control input-field" id="harga_satuan_produksi" placeholder="Contoh: 69.000">
          </div>
          <div class="col-lg-6 mb-3">
            <label for="kuantitas_produksi" class="form-label">Kuantitas (Kg)</label>
            <input type="text" class="form-control input-field" id="kuantitas_produksi" placeholder="Contoh: 10">
          </div>
        </div>
        <div class="row">
          <div class="col mb-3">
